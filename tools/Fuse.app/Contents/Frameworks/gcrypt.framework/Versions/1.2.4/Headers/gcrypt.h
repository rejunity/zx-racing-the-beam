...
#define _GCRY_PTH_SOCKLEN_T gcry_socklen_t
...
struct gcry_thread_cbs
{
  ...
  int (*accept) (int s, _GCRY_PTH_SOCKADDR *addr, gcry_socklen_t *length_ptr);
  int (*connect) (int s, _GCRY_PTH_SOCKADDR *addr, gcry_socklen_t length);
